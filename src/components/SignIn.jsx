...
const SignIn = () => {
  ...
  return (
    <div style={{ width: '100%' }}>
      <Box display="flex" flexDirection="column" bgcolor="background.paper" justifyContent="center">
        
        <Box style={{ width: '50%' }}>
          <img src="../assets/signin-img.jpeg"></img>
        </Box>

      <Box className="mt-8" style={{ width: '30%' }} justifyContent="center" m="auto">
